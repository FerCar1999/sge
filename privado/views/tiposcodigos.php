...
<html>
	...
	<body>
			...
			<div class="row">
					...
					<div class="card">
						<div class="card-content">
							<div class="input-field col  s12">									
								<input id="buscar_tipoCodigo" type="text" class="validate">
							...
							<div class="footer">
								<div class="stats">
									<a id="ver_tiposCodigos_activas" href="#!">Activos</a> |
									<a id="ver_tiposCodigos_inactivas" href="#!">Inactivos</a>
								</div>
							</div>
				...
				<div class="col s12 m12 l6">
					<div class="card" id="formAgregar">
						<div class="card-content">
							<span class="card-title">Tipo de código</span>
							<div class="row">
								<div class="input-field col s12">
					...
					<div class="card" id="formMod">
						<div class="card-content">
							<span class="card-title">Modificar tipo de código</span>
							<div class="row">
								<div class="input-field col s12">
									<i class="material-icons prefix">assignment_turned_in</i>
								...
								<div class="input-field col s12">
									<i class="material-icons prefix">pan_tool</i>
          							<input id="mod_cantidad" type="text">
          							<label for="mod_cantidad">Cantidad</label>
								</div>
								<div class="input-field col s12">
									<i class="material-icons prefix">swap_vert</i>
          							<input id="mod_escala" type="text">
          							<label for="mod_escala">Escala</label>
								</div>
								<div class="input-field col s12">
									<i class="material-icons prefix">subject</i>
					...
					<div class="card" id="formElim">
						<div class="card-content">
							<span class="card-title">Desactivar tipo de código</span>
							<div class="row">
					...
					<div class="card" id="formAct">
						<div class="card-content">
							<span class="card-title">Activar tipo de código</span>
							<br>
							<div class="row">
		...
		<script type="text/javascript" src="/privado/js/tiposcodigos.js"></script>
	</body>
</html>