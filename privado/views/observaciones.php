	...
	<body>
		...
		<div class="content">
			<div class="row">
				...
				<div class="col s12 right-align">
					<br>
					<a class="btn-floating btn-large waves-effect waves-light amber darken-4 tooltipped" data-position="left" data-delay="50" data-tooltip="Limpiar búsqueda de alumnos" id="limpiar_datos">
