<?php 
    ...
    <body>
        ...
        <div class="content">
            ...
            <p style="font-weight:bold;font-size:12pt;padding-top:15mm">REPORTE DE INASISTENCIAS TOTALES</p>
            ...
            <p style="text-align:center;font-weight:bold;font-size:12pt;margin-top:10mm">REPORTE ESTADÍSTICO DE '.strtoupper($nombreNivel[0]).' INASISTENCIAS TOTALES</p>
            <p style="text-align:center;font-weight:bold;font-size:12pt;">DEL '.date('d/m/Y',strtotime($inicio)).' AL '.date('d/m/Y',strtotime($fin)).'</p>';
            $estudiantes = reportesData::inasistenciasT($inicio, $fin, $nivel);
            $studentData = array();
            if (count($estudiantes)>0) {
                ...
                foreach($estudiantes as $estudiante){
                    $data = reportesData::estudianteJustificado($estudiante[0], $inicio, $fin);
