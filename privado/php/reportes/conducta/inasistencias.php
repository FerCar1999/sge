    ...
    $html = '<html>
        ...
        <body>
            ...
            <div class="content">
                ...
                <p style="text-align:center;font-weight:bold;padding-top:1mm;padding-left:10mm;font-size:13pt;">INASISTENCIAS TOTALES A LA INSTITUCIÓN</p>
                ...
                if ($inicio === "" && $fin === "") {
                    $inasistencias = reportesData::inasistencias();
                }else{
                    $inasistencias = reportesData::inasistencias($inicio,$fin);
                }
                if (count($inasistencias)>0) {
                    ...
                    <tr>
                        ...
                        <th style="height:8mm;border:solid 1px black;font-size:11pt;width:60mm;">Curso</th>
                    </tr>';
                    foreach ($inasistencias as $row) {
                        ...
                        <tr>
                            ...
                            $c.'</p></td>
                            <td style="height:8mm;border:solid 1px black;font-size:9pt;text-align:center;"><p>'.date("d-m-Y",strtotime($row['fecha'])).'</p></td>
                            ...
                            <td style="height:8mm;border:solid 1px black;font-size:9pt;"><p>'.$row['grado'].'</p></td>
                        </tr>';   
                    }
                    $html .= '
                        </tbody>
