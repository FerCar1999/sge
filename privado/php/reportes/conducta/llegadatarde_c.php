    ...
    $html = '<html>
        ...
        <body>
            ...
            <div class="content">
                ...
                <p style="text-align:center;font-weight:bold;padding-top:1mm;padding-left:10mm;font-size:13pt;">LLEGADAS TARDE A CLASE</p>
                ...
                if ($inicio === "" && $fin === "") {
                    $llegadasTardeClase = reportesData::llegadasTardeClaseTotal();
                }else{
                    $llegadasTardeClase = reportesData::llegadasTardeClaseTotal($inicio,$fin);
                }
                if (count($llegadasTardeClase)>0) {
                    $c = 0;
                    $html .= 
                    '<table style="width:190mm;margin-left:10mm;padding-top:10mm;border-collapse:collapse;margin-top:10mm;" cellspacing="0" cellpadding="0">
                    <tbody>
                    <tr>
                        ...
                        <th style="height:8mm;border:solid 1px black;font-size:11pt;width:55mm;">Asignatura</th>
                    ...
                    foreach ($llegadasTardeClase as $row) {
                        ...
                        <tr>
                            ...
                            $c.'</p></td>
                            <td style="height:8mm;border:solid 1px black;font-size:10pt;text-align:center;"><p>'.date("d-m-Y",strtotime($row['fecha'])).'</p></td>
                            <td style="height:8mm;border:solid 1px black;font-size:10pt;text-align:center;"><p>'.$row['codigo'].'</p></td>
                            <td style="height:8mm;border:solid 1px black;font-size:10pt;padding-left:2mm;"><p>'.$row['nombre'].'</p></td>
                            <td style="height:8mm;border:solid 1px black;font-size:10pt;padding-left:2mm;"><p>'.$row['asignatura'].'</p></td>
                            <td style="height:8mm;border:solid 1px black;font-size:10pt;text-align:center;"><p>'.$row['grado'].'</p></td>
                        </tr>';
                    }
                    //.$row['estado'].
                    $html .= '
