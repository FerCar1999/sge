    ...
    class reportesData
    {
        ...
        function bloquesJustificados($fecha_inicio, $fecha_fin, $pk_alumno){
            $sql = "SELECT 
                        ...
                        b.fecha AS fecha,
                        CONCAT('Inasistencia clase - ', a.nombre) AS motivo,
                        'normal' AS tipo,
                        'Justificada' AS estado
        ...
        //FUNCION YA NO UTILIZADA POR QUE LA TABLA YA NO SE UTILIZA
        function ausenciasJustificadas($fecha_inicio, $fecha_fin, $pk_alumno){
            $sql = "SELECT CONCAT('Insistencia total - ',a.motivo, ' desde ', a.inicio , ' hasta ', a.fin) AS motivo, a.inicio AS fecha, a.fin, CONCAT('Justificada') as estado, CONCAT('normal') AS tipo
