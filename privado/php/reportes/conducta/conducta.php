    ...
    $html = '<html>
        ...
        <body>
            ...
            foreach($etapas as $row){
                ...
                /*if (count($inasistenciasinst) > 0 || count($ausenciasJustificadas) > 0) {
                    foreach ($inasistenciasinst as $asist) {
                        ...
                        <tr>
                            ...
                            <td style="height:8mm;text-align:center;border:solid 1px black;"><p>'.$asist['motivo'].'</p></td>
                    ...
                    foreach ($ausenciasJustificadas as $ausenciaJ) {
                        ...
                        <tr>
                            <td style="height:8mm;padding-left:2mm;border:solid 1px black;"><p>'.$c.'</p></td>
                            <td style="height:8mm;padding-left:2mm;border:solid 1px black;"><p>'.date('d-m-Y',strtotime($ausenciaJ['fecha'])).'</p></td>
                            <td style="height:8mm;text-align:center;border:solid 1px black;"><p>'.$ausenciaJ['motivo'].'<b></p></td>
                ...
                /*foreach ($ausenciasJustificadas as $key) {
                    array_push($array1, $key);
                }*/
                usort($array1, "date_sort2");
                //print_r($array1);
                //usort($inasistenciasClase, "date_sort2");
