<?php
    ...
    $query = "select s.id_suspendido,e.codigo,e.nombres,e.apellidos,g.nombre as grado,es.nombre as espe,e.foto,s.observacion from estudiantes e, grados g, especialidades es, suspendidos s
where s.id_personal is null and s.id_estudiante= e.id_estudiante and e.id_grado=g.id_grado and  e.id_especialidad=es.id_especialidad ";
...
where s.id_personal is null and s.id_estudiante= e.id_estudiante and e.id_grado=g.id_grado and  e.id_especialidad=es.id_especialidad ";
    ...
    $stmt->bind_result($id_suspendido, $codigo, $nombres,$apellidos,$grado,$espe,$foto,$observacion);
    ...
    while ($stmt->fetch()) {
        ...
        $supendidos["url"] =$foto;
        $supendidos["observacion"] =$observacion;
