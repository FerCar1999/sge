<?php
    ...
    $data = Database::getRow("SELECT correo FROM personal WHERE codigo = ?", "HK99");
                                            ...
                                            <td colspan="3" align="center">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <p style="font-family:HelveticaNeue-Light,arial,sans-serif;font-size:25px;color:#404040;line-height:25px;font-weight:bold;margin:0;padding:0">AVISO DE CONTROL DE ASISTENCIA EN CLASE<p/>
                                                        </td>
                                                        <td width="25"></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3" height="40"></td></tr><tr><td colspan="5" align="justify">
                                                            <p style="color:#404040;font-size:16px;line-height:24px;font-weight:lighter;padding:0;margin:0">Se informa que el docente '.$row["p.nomre"]. ' '.$row["p.apellido"].' tomó la asistencia en clase.</p><br>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
