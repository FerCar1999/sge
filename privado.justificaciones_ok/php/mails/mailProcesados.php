<?php
    ...
    $data = Database::getRow("SELECT correo FROM estudiantes WHERE codigo = ?", array($pk_alumno));
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="3" height="40"></td></tr><tr><td colspan="5" align="justify">
                                                            <p style="color:#404040;font-size:16px;line-height:24px;font-weight:lighter;padding:0;margin:0">Estimado responsable, se le informa que el (la) estudiante ha incurrido en varias faltas hasta la fecha, por lo que se pide estar más atento(a) de esta situación para mejorar su conducta y revisar constantemente su expediente en el SGE, atentamente,</p><br>
