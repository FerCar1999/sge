<?php 
    ...
    <body>
        ...
        <div class="content">
            ...
            <p style="font-weight:bold;font-size:12pt;padding-top:15mm">REPORTE DE INASISTENCIAS INJUSTIFICADAS</p>
            ...
            $estudiantes1 = reportesData::inasistenciasT($inicio, $fin, $nivel, 'Injustificada');
            $estudiantes2 = reportesData::inasistenciasClasesT($inicio, $fin, $nivel, 'Injustificada');
            ...
            if (count($estudiantes1) > 0 || count($estudiantes2) > 0) {
                ...
                for ($i=0; $i < count($resultado); $i++) { 
                    ...
                    $cantC = reportesData::countJustificadoClase($resultado[$i], $inicio, $fin, 'Injustificada');
                    $cantT = reportesData::countJustificado($resultado[$i], $inicio, $fin, 'Injustificada');
                    $cantidadTotal = count($cantC) + count($cantT);
