<?php 
    ...
    $html = '<html>
    <head>
        <title>Instituto Técnico Ricaldone | Reporte inasistencias a clase </title>
    ...
    <body>
        ...
        <div class="content">
            ...
            <p style="font-weight:bold;font-size:12pt;padding-top:15mm">REPORTE DE INASISTENCIAS A CLASES</p>
            ...
            <p style="text-align:center;font-weight:bold;font-size:12pt;margin-top:10mm">REPORTE ESTADÍSTICO DE '.strtoupper($nombreNivel[0]).' INASISTENCIAS A CLASES</p>
            <p style="text-align:center;font-weight:bold;font-size:12pt;">DEL '.date('d/m/Y',strtotime($inicio)).' AL '.date('d/m/Y',strtotime($fin)).'</p>';
            $estudiantes = reportesData::inasistenciasClasesT($inicio, $fin, $nivel);
            //$estudiantes = reportesData::inasistenciasClasesJustificadas($inicio, $fin, $nivel);
            $studentData = array();
            if (count($estudiantes)>0) {
                ...
                foreach($estudiantes as $estudiante){
                    $data = reportesData::estudianteJustificadoClase($estudiante[0], $inicio, $fin);
