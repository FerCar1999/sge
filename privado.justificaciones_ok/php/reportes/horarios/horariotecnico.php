<?php 
    ...
    require_once($_SERVER['DOCUMENT_ROOT']."/privado/php/reportes/horarios/classHorarioAlumno.php");

    session_start();
    //GRUPO TECNICO, GRUPO ACADEMICO, GRADO, SECCION
    $alumno = horariosAlumno::getAlumno($_SESSION["codigo"]);
    foreach ($alumno as $value) {
        horariosAlumno::horarioAlumno($value[1],"",$value[2],$value[3]);
    }
...
'<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            <p style="text-align:center;font-weight:bold;padding-left:10mm;font-size:13pt;">'.$alumno[0][4].'</p>
            <br>
