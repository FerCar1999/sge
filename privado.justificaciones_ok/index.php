...
<html>
        		...
        		<div class="card-panel grey lighten-5 z-depth-1">
          			...
          			<div class="row">
	      					...
	      					<div class="row center-align">
	      						<button onclick="loginAjax();" class="btn-floating btn-large blue"><i class='material-icons'>verified_user</i></button>
	      					</div>
	                <div class="row center-align">
	                  <a href="" id="olvidepass">OLVIDÉ MI CONTRASEÑA</a>
	                </div>
          			</div>
        		</div>
      		</div>
    ...
    <script type="text/javascript" src="/privado/js/login.js"></script>
	</body>
</html>
