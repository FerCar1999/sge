...
<html>
	...
	<body>
			...
			<div class="row">
					...
					<div class="card">
						<div class="card-content">
							<div class="input-field col  s12">									
								<input id="buscar_tipoAsignatura" type="text" class="validate">
							...
							<div class="footer">
								<div class="stats">
									<a id="ver_tiposAsignaturas_activas" href="#!">Activos</a> |
									<a id="ver_tiposAsignaturas_inactivas" href="#!">Inactivos</a>
								</div>
							</div>
				...
				<div class="col s12 m12 l6">
					<div class="card" id="formAgregar">
						<div class="card-content">
							<span class="card-title">Tipo de asignatura</span>
							<div class="row">
								<div class="input-field col s12">
					...
					<div class="card" id="formMod">
						<div class="card-content">
							<span class="card-title">Modificar tipo de asignatura</span>
							<div class="row">
								<div class="input-field col s12">
									<i class="material-icons prefix">assignment_turned_in</i>
					...
					<div class="card" id="formElim">
						<div class="card-content">
							<span class="card-title">Desactivar tipo de asignatura</span>
							<div class="row">
					...
					<div class="card" id="formAct">
						<div class="card-content">
							<span class="card-title">Activar tipo de asignatura</span>
							<br>
							<div class="row">
		...
		<script type="text/javascript" src="/privado/js/tiposasignaturas.js"></script>
	</body>
</html>