...
<html>
	...
	<body>
			...
			<div class="row">
					...
					<div class="card">
						<div class="card-content">
							<div class="input-field col  s12">									
								<input id="buscar_etapa" type="text" class="validate">
							...
							<div class="footer">
								<div class="stats">
									<a id="ver_etapas_activas" href="#!">Activos</a> |
									<a id="ver_etapas_inactivas" href="#!">Inactivos</a>
								</div>
							</div>
				...
				<div class="col s12 m12 l6">
					<div class="card" id="formAgregar">
						<div class="card-content">
							<span class="card-title">Etapa</span>
							<div class="row">
								<div class="input-field col s12">
								...
								<div class="input-field col s12" id="divSelect">
									...
									<label class="selectlbl">Nivel</label>
								</div>
					...
					<div class="card" id="formMod">
						<div class="card-content">
							<span class="card-title">Modificar etapa</span>
							<div class="row">
								<div class="input-field col s12">
									<i class="material-icons prefix">assignment_turned_in</i>
					...
					<div class="card" id="formElim">
						<div class="card-content">
							<span class="card-title">Desactivar etapa</span>
							<div class="row">
					...
					<div class="card" id="formAct">
						<div class="card-content">
							<span class="card-title">Activar etapa</span>
							<br>
							<div class="row">
		...
		<script type="text/javascript" src="/privado/js/etapas.js"></script>
	</body>
</html>