<?php 
	...
	class horariosAlumno
	{
		...
		function clases($grupo_tecnico = "", $grupo_academico = "", $grado, $seccion, $especialidad)
		{
			$sql = "";
			$params = array();
			if ($grupo_academico === "") {
				$sql = "SELECT 
					...
					$params = array($grupo_tecnico, $seccion, $grado, $especialidad);
		...
		function horarioAlumno($grupo_tecnico = "", $grupo_academico = "", $grado, $seccion, $especialidad){
			$clases = self::clases($grupo_tecnico, $grupo_academico, $grado, $seccion, $especialidad);
